        ...
        <ul class="nav nav-stacked">
            ...
            <li role="presentation" id="left-nav" class="active">
                ...
                <ul id="list" class="collapse in">
                    <li class="active">
                        <a href="/searchAllWorking?sign=888" style="color: black" target="mainFrame">查询考勤</a>
                    </li>
                    <li>
                        <a href="/searchAllWorking?sign=666" style="color: black" target="mainFrame">修改考勤</a>
                    </li>
                </ul>
            </li>
            <li role="presentation"><a data-toggle="collapse" data-target="#list1"
                ...
                <ul id="list1" class="collapse in">
                    <li class="active">
                        <a href="/searchAllSalary?sign=888" style="color: black" target="mainFrame">查询工资</a>
                    </li>
                    <li>
                        <a href="/searchAllSalary?sign=666" style="color: black" target="mainFrame">修改工资</a>
                    </li>
            ...
            <li role="presentation"><a data-toggle="collapse" data-target="#list2"
                ...
                <ul id="list2" class="collapse in">
                    <li class="active">
                        <a href="/searchallmessage?sign=888" style="color: black" target="mainFrame">查询员工</a>
                    </li>
                    <li>
                        <a href="/searchallmessage?sign=666" style="color: black" target="mainFrame">信息管理</a>
                    </li>
                </ul>
            </li>
                ...
                <li role="presentation"><a data-toggle="collapse" data-target="#list3"
                    ...
                    <ul id="list3" class="collapse in">
                        <li class="active">
                            <a href="/findinforbyun" style="color: black" target="mainFrame">个人用户</a>
                        </li>
                        <li>
                            <a href="/searchalluser" style="color: black" target="mainFrame">查询用户</a>
                        </li>
                    </ul>
                </li>
