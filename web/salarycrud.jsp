...
<div class="container container-small">
    <form name="form" method="post">
        <table class="table">
            ...
            <tr>
                ...
                <td><a class = "btn btn-default btn-sm" href = "/searchSalaryById?id=<%=salary.getId()%>">修改</a></td>
                <td><a class = "btn btn-default btn-sm"href="javascript:warning(<%=salary.getId()%>)">删除</a></td>
                <%} %>
            </tr>
            </tbody>
        </table>
    ...
    <div style="text-align: center">
        <a class = "btn btn-default btn-sm" href = "addsalary.jsp">添加信息</a>
    </div>
</div>
<script>
    function warning(id) {
